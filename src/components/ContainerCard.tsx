    ...
    >
      ...
      >
        <TiltCard
          maxTilt={6}
          shineOpacity={0.15}
          className="relative flex h-[357px] w-full flex-col justify-between rounded-[14px] border border-white/10 bg-[#19161c] px-7 py-8 shadow-[0_58px_70px_rgba(0,0,0,0.4)] transition-all duration-300 hover:border-white/20 sm:px-[44px] sm:pt-[42px] sm:pb-[40px]"
        >
          ...
          <div className="flex items-center gap-[22px]">
            ...
            <motion.a
              ...
              className="flex h-[44px] w-[189px] items-center justify-between rounded-[24px] border border-white/80 bg-white/5 px-5 text-white cursor-pointer select-none transition-colors duration-200 hover:border-white hover:bg-white/10"
            >
      ...
      >
        <TiltCard
          maxTilt={6}
          shineOpacity={0.15}
          className="relative flex h-[357px] w-full flex-col justify-between rounded-[14px] border border-white/10 bg-[#19161c] px-7 py-8 shadow-[0_58px_70px_rgba(0,0,0,0.4)] transition-all duration-300 hover:border-white/20 sm:px-[54px] sm:pt-[49px] sm:pb-[40px]"
        >
          ...
          <div className="group flex h-[64px] w-full max-w-[423px] items-center justify-between rounded-full border border-white/5 bg-[#0a0a0a] py-[9px] pl-[21px] pr-[10px] transition-all duration-300 hover:border-white/20">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              transition={{ duration: 0.2, ease: EASE_EXPO }}
              className="flex h-[46px] w-[104px] items-center justify-center rounded-full bg-[#d2ff3a] border border-black font-[family-name:var(--font-work)] text-[15px] font-medium leading-[1.33] text-black shadow-md shadow-[#d2ff3a]/10 cursor-pointer select-none"
            >
              Generate
            </motion.button>
          </div>
